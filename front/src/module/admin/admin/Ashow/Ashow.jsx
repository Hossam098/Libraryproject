...
const AShow = () => {
    ...
    useEffect(() => {
        axios.get(`${API_URL}/admin/getuserbyid/${data.ser_id}/${data.ser_name}/${data.student_id}/${data.app_id}`, { withCredentials: true })
            .then((res) => {
                setUser(res.data)
            }).catch((error) => {
    ...
    const handelAccept = () => {
        if (response.response_text !== '') {
            ...
            try {
                ...
                axios.put(`${API_URL}/admin/acceptApplicant/${user.national_id}`, formData, {
