...
const Ser3 = ({ ser }) => {
  ...
  const handleSubmit = () => {
    ...
    try {
      axios
        .put(`${API_URL}/StepTwoSer3/${id}/${id2}`, formData, {
          withCredentials: true,
              ...
              <div className="inputt ">
                ...
                >
                  ...
                  <input
                    ...
                    name=""
                    onChange={(e) => {
                      setData({ ...data, accept_date: e.target.value });
                    }}
                  />
                  {data.accept_date && (
                    <>
                ...
                >
                  ...
                  <input
                    ...
                    name=""
                    onChange={(e) => {
                      setData({ ...data, puplish_date: e.target.value });
                    }}
                  />
                  {data.puplish_date && (
                    <>
