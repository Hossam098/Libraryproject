...
import { BsFilePdf, BsFileEarmarkWord, BsFileEarmarkPdf } from 'react-icons/bs'
...
const Ser5 = ({ ser }) => {
    ...
    const handleSubmit = () => {
        ...
        formData.append('a7a1', a7as.a7a1)
        formData.append('a7a2', a7as.a7a2)
        formData.append('a7a3', a7as.a7a3)
        formData.append('a7a4', a7as.a7a4)
        formData.append('a7a5', a7as.a7a5)
        formData.append('a7a6', a7as.a7a6)
        formData.append('a7a8', a7as.a7a7)
        formData.append('a7a9', a7as.a7a8)
                                ...
                                }
                                {
                                    Array.from(Array(number), (e, i) => (
                                        <React.Fragment key={i}>
                                            <div className="select-img">
                                                <span className="title-upload">
                                                    {t(`service${id}-step-two.a7a${i + 1}`)}
                                                </span>
                                                <label className="upload-image" htmlFor={`a7a${i}`}>
                                                    <AiOutlineFileAdd  className="img-icom" />
                                                    <p>{t('click-here')}</p>
                                                </label>
                                                <input
                                                    type="file"
                                                    ...
                                                    name={`a7a${i}`}
                                                    onChange={(e) => {
                                                        seta7as({ ...a7as, [`a7a${i + 1}`]: e.target.files[0] });
                                                ...
                                                {a7as[`a7a${i + 1}`] && (
                                                    <div className="text-container">
                                                        <p className='upload-image value'>
                                                            {a7as[`a7a${i + 1}`].name?a7as[`a7a${i + 1}`].name:a7as[`a7a${i + 1}`]}
                                                        </p>
                                                        <button className='upload-image openPdf'
                                                            onClick={() => {
                                                                if (a7as[`a7a${i + 1}`].name) {
                                                                    return window.open(URL.createObjectURL(a7as[`a7a${i + 1}`]))
                                                                } else {
                                                                    return window.open(`http://localhost:5000/${ser.national_id}/${a7as[`a7a${i + 1}`]}`)
                                                                }
                                                            }}
                                                        >{t('open')}</button>
                                                        <AiFillCloseCircle
                                                            onClick={() => { seta7as({ ...a7as, [`a7a${i + 1}`]: '' }) }}
                                                            style={{ color: '#ad8700', fontSize: '2rem', cursor: 'pointer' }}
                                                        />
                                                    </div>
                                                )}
