...
const Ser5 = ({ ser }) => {
                ...
                axios.get(`${API_URL}/StepTwoRegEdit/${id}/${id2}`, { withCredentials: true })
                    .then((res) => {
                        ...
                        setPdfs({
                            ...
                            pdf11: res.data.acceptance_letter1 !== null ? res.data.acceptance_letter1 : '',
                            pdf12: res.data.acceptance_letter2 !== null ? res.data.acceptance_letter2 : '',
                            pdf13: res.data.acceptance_letter3 !== null ? res.data.acceptance_letter3 : '',
                            pdf14: res.data.acceptance_letter4 !== null ? res.data.acceptance_letter4 : '',
                            pdf15: res.data.acceptance_letter5 !== null ? res.data.acceptance_letter5 : '',
                            pdf16: res.data.acceptance_letter6 !== null ? res.data.acceptance_letter6 : '',
                            pdf17: res.data.acceptance_letter7 !== null ? res.data.acceptance_letter7 : '',
                            pdf18: res.data.acceptance_letter8 !== null ? res.data.acceptance_letter8 : '',
                            pdf19: res.data.acceptance_letter9 !== null ? res.data.acceptance_letter9 : '',
                            pdf20: res.data.acceptance_letter10 !== null ? res.data.acceptance_letter10 : '',
                        })
    ...
    const handleSubmit = () => {
        ...
        try {
            axios.put(`${API_URL}/StepTwoSer5/${id}/${id2}`, formData,
                {
                                    ...
                                    Array.from(Array(number), (e, i) => (
                                        <React.Fragment key={i}>
                                            ...
                                            <div className="select-img two">
                                                ...
                                                <label className="upload-image" htmlFor={`acceptance_letter${i}`}>
                                                    <BsFilePdf className="img-icom" />
                                                    <p>{t('click-here')}</p>
                                                </label>
                                                <input
                                                    ...
                                                    onChange={(e) => {
                                                        setPdfs({ ...pdfs, [`pdf${i + 11}`]: e.target.files[0] });
                                                ...
                                                {pdfs[`pdf${i + 11}`] && (
                                                    <div className="text-container">
                                                        <p className='upload-image value'>
                                                            {pdfs[`pdf${i + 11}`].name ? pdfs[`pdf${i + 11}`].name : pdfs[`pdf${i + 11}`]}
                                                        </p>
                                                        <button className='upload-image openPdf'
                                                            onClick={() => {
                                                                if (pdfs[`pdf${i + 1}`].name) {
